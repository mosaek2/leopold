        ...
        <div className="cart-table">
            <div className="cart-table-key-container">
                ...
                <div className="cart-table-key-box" style={{ width: 169 }}>
                    <img src={cart?.coverUrl} alt="cover" style={{ width: 120, height: 120, borderRadius: 12 }} />
                </div>

                <div className="cart-table-key-box" style={{ width: 379, alignItems: "start", paddingLeft: 10 }}>
                    <p>{cart?.name} {cart?.color}</p>
                    <p>[옵션: {cart?.engraving}/{cart?.switchValue}]</p>
                </div>
                ...
                <div className="cart-table-key-box" style={{ width: 128 }}>
                    <input type="number" defaultValue={cart?.quantity}
                        ...
                        onChange={(e) => { setNewQuantity(e.target.value) }} min={1} />
                    <button className="cart-table-small-btn" style={{ width: 92, height: 26 }}
                        onClick={handleClickNewQuantity}>수량변경</button>
                </div>
