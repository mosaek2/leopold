        ...
        <div>
          <div className="best-prouduct">
            ...
            <div className="best-prouduct-group">
              <p className="home-title-boldtext">BEST PRODUCT</p>
              <p
          ...
          <div className="service-container">
            ...
            <p className="home-title-lighttext" style={{ marginTop: "25px" }}>
              궁금한 점이 있으신가요? <br /> 레오폴드가 키보드 그 이상의 가치를
              느끼게 해드립니다
            </p>
            <div className="service-group">
              ...
              <Link to="/as">
                <div className="service-box">
                  <img
                    style={{ marginTop: "35px" }}
                    src="\images\Home\AS.png"
                  ></img>
                  <p className="service-boldtext">A/S 접수</p>
                  <p className="service-light">
                    도움이 필요하시면 언제든지 문의해주세요. <br /> 최대한
                    빠르게 도움 드리겠습니다.
                  </p>
                </div>
              </Link>
