...
export default function Modify() {
  ...
  function handleClickJoin() {
    ...
    if (agreeClause1 === false) {
      alert("이용약관에 동의해 주세요.");
      return;
    }

    if (agreeClause2 === false) {
    ...
    <div className="Modify">
      ...
      <Main>
        ...
        <div className="join-small-title-wrapper">
          ...
          <p className="join-must">
            <span className="join-red-star">*</span> 필수입력사항
          </p>
        </div>
        ...
        <div className="join-info-wrapper">
          ...
          <tr>
            <td className="join-key">일반전화</td>
            <td className="join-value">
              <div className="join-phoneWrapper">
                <input
                  maxLength={4}
                  className="join-input4"
                  defaultValue={phoneAlt1}
                  onFocus={() => {
                    setPhoneAlt1("");
                  }}
                  onChange={(e) => {
        ...
        <div className="join-all-agree-box">
          <input
            ...
            onChange={() => {
              if (agreeAll === false) {
                setAgreeAll(true);
                setAgreeClause1(true);
                setAgreeClause2(true);
                setAgreeSms(true);
                setAgreeEmail(true);
              } else {
                setAgreeAll(false);
                setAgreeClause1(false);
                setAgreeClause2(false);
                setAgreeSms(false);
                setAgreeEmail(false);
              }
            }}
          />
          <label for="join-clause-all">
        ...
        <div className="join-agree-wrapper">
          <div className="join-agree-box">
            <input
              type="checkbox"
              id="join-clause1"
              checked={agreeClause1}
              onChange={() => {
                setAgreeClause1(!agreeClause1);
              }}
            />
            <label for="join-clause1">[필수] 이용약관 동의</label>
            <p
              className="join-see-clause"
              onClick={() => {
                setIsClause1Show(!isClause1Show);
              }}
            >
              약관보기
            </p>
          ...
          <div
            className={
              isClause1Show ? "join-clause" : "join-clause join-clause-hide"
            }
          >
            <p>
              ** 해당 서식은 공정거래위원회에서 제공하는 전자상거래 표준
              약관으로 쇼핑몰 운영형태에 따른 수정이 필요할 수 있습니다.
              쇼핑몰에 적용하시기 전 쇼핑몰 운영 사항 등을 확인하시고 관련 법령
              등을 감안하여 적절한 내용을 반영하여 이용하시기 바랍니다. **
              <br />
              &nbsp;
              <br />
              제1조(목적)
              <br />이 약관은 레오폴드(주)가 운영하는 레오폴드 온라인
              쇼핑몰(이하 “몰”이라 한다)에서 제공하는 인터넷 관련 서비스(이하
              ...
              수 있습니다.
              <br />
              [2] “몰”은 제1항의 사유로 서비스의 제공이 일시적으로 중단됨으로
              인하여 이용자 또는 제3자가 입은 손해에 대하여 배상합니다. 단,
              “몰”이 고의 또는 과실이 없음을 입증하는 경우에는 그러하지
              아니합니다.
              <br />
              [3] 사업종목의 전환, 사업의 포기, 업체 간의 통합 등의 이유로
              ...
              제6조(회원가입)
              <br />
              [1] 이용자는 “몰”이 정한 가입 양식에 따라 회원정보를 기입한 후 이
              약관에 동의한다는 의사표시를 함으로서 회원가입을 신청합니다.
              <br />
              [2] “몰”은 제1항과 같이 회원으로 가입할 것을 신청한 이용자 중 다음
              ...
              판단되는 경우
              <br />
              [3] 회원가입계약의 성립 시기는 “몰”의 승낙이 회원에게 도달한
              시점으로 합니다.
              <br />
              [4] 회원은 회원가입 시 등록한 사항에 변경이 있는 경우, 상당한 기간
              이내에 “몰”에 대하여 회원정보 수정 등의 방법으로 그 변경사항을
              알려야 합니다.
              <br />
              제7조(회원 탈퇴 및 자격 상실 등)
              <br />
              [1] 회원은 “몰”에 언제든지 탈퇴를 요청할 수 있으며 “몰”은 즉시
              회원탈퇴를 처리합니다.
              <br />
              [2] 회원이 다음 각 호의 사유에 해당하는 경우, “몰”은 회원자격을
              제한 및 정지시킬 수 있습니다.
              <br />
              ...
              반하는 행위를 하는 경우
              <br />
              [3] “몰”이 회원 자격을 제한․정지 시킨 후, 동일한 행위가 2회 이상
              반복되거나 30일 이내에 그 사유가 시정되지 아니하는 경우 “몰”은
              회원자격을 상실시킬 수 있습니다.
              <br />
              [4] “몰”이 회원자격을 상실시키는 경우에는 회원등록을 말소합니다.
              이 경우 회원에게 이를 통지하고, 회원등록 말소 전에 최소한 30일
              이상의 기간을 정하여 소명할 기회를 부여합니다.
              <br />
              제8조(회원에 대한 통지)
              <br />
              [1] “몰”이 회원에 대한 통지를 하는 경우, 회원이 “몰”과 미리
              약정하여 지정한 전자우편 주소로 할 수 있습니다.
              <br />
              [2] “몰”은 불특정다수 회원에 대한 통지의 경우 1주일이상 “몰”
              ...
              <br />
              [1] “몰”이용자는 “몰”상에서 다음 또는 이와 유사한 방법에 의하여
              ...
              &nbsp; 6. 결제방법의 선택
              <br />
              [2] “몰”이 제3자에게 구매자 개인정보를 제공할 필요가 있는 경우 1)
              ...
              <br />
              [3] “몰”이 제3자에게 구매자의 개인정보를 취급할 수 있도록 업무를
              ...
              제10조 (계약의 성립)
              <br />
              [1] &nbsp;“몰”은 제9조와 같은 구매신청에 대하여 다음 각 호에
              ...
              <br />
              [1] “몰”은 이용자의 구매신청이 있는 경우 이용자에게 수신확인통지를
              합니다.
              <br />
              ...
              제13조(재화 등의 공급)
              <br />
              [1] “몰”은 이용자와 재화 등의 공급시기에 관하여 별도의 약정이 없는
              ...
              &nbsp;이때 “몰”은 이용자가 재화 등의 공급 절차 및 진행 사항을
              확인할 수 있도록 적절한 조치를 합니다.
              <br />
              [2] “몰”은 이용자가 구매한 재화에 대해 배송수단, 수단별 배송비용
              ...
              제15조(청약철회 등)
              <br />
              [1] “몰”과 재화등의 구매에 관한 계약을 체결한 이용자는
              ...
              따릅니다.
              <br />
              [2] 이용자는 재화 등을 배송 받은 경우 다음 각 호의 1에 해당하는
              ...
              등의 포장을 훼손한 경우
              <br />
              [3] 제2항제2호 내지 제4호의 경우에 “몰”이 사전에 청약철회 등이
              ...
              제16조(청약철회 등의 효과)
              <br />
              [1] “몰”은 이용자로부터 재화 등을 반환받은 경우 3영업일 이내에
              ...
              <br />
              [2] “몰”은 위 대금을 환급함에 있어서 이용자가 신용카드 또는
              ...
              제18조(“몰“의 의무)
              <br />
              [1] “몰”은 법령과 이 약관이 금지하거나 공서양속에 반하는 행위를
              하지 않으며 이 약관이 정하는 바에 따라 지속적이고, 안정적으로
              재화․용역을 제공하는데 최선을 다하여야 합니다.
              <br />
              [2] “몰”은 이용자가 안전하게 인터넷 서비스를 이용할 수 있도록
              이용자의 개인정보(신용정보 포함)보호를 위한 보안 시스템을 갖추어야
              합니다.
              <br />
              [3] “몰”이 상품이나 용역에 대하여 「표시․광고의 공정화에 관한
              법률」 제3조 소정의 부당한 표시․광고행위를 함으로써 이용자가
              손해를 입은 때에는 이를 배상할 책임을 집니다.
              <br />
              [4] “몰”은 이용자가 원하지 않는 영리목적의 광고성 전자우편을
              발송하지 않습니다.
              <br />
              제19조(회원의 ID 및 비밀번호에 대한 의무)
              <br />
              [1] 제17조의 경우를 제외한 ID와 비밀번호에 관한 관리책임은
              회원에게 있습니다.
              <br />
              ...
              <br />
              [1] 상위 “몰”과 하위 “몰”이 하이퍼링크(예: 하이퍼링크의 대상에는
              문자, 그림 및 동화상 등이 포함됨)방식 등으로 연결된 경우, 전자를
              연결 “몰”(웹 사이트)이라고 하고 후자를 피연결 “몰”(웹사이트)이라고
              합니다.
              <br />
              [2] 연결“몰”은 피연결“몰”이 독자적으로 제공하는 재화 등에 의하여
              ...
              제22조(저작권의 귀속 및 이용제한)
              <br />
              [1] “몰“이 작성한 저작물에 대한 저작권 기타 지적재산권은 ”몰“에
              귀속합니다.
              <br />
              [2] 이용자는 “몰”을 이용함으로써 얻은 정보 중 “몰”에게
              지적재산권이 귀속된 정보를 “몰”의 사전 승낙 없이 복제, 송신, 출판,
              배포, 방송 기타 방법에 의하여 영리목적으로 이용하거나 제3자에게
              이용하게 하여서는 안됩니다.
              <br />
              [3] “몰”은 약정에 따라 이용자에게 귀속된 저작권을 사용하는 경우
              당해 이용자에게 통보하여야 합니다.
              <br />
              제23조(분쟁해결)
              <br />
              [1] “몰”은 이용자가 제기하는 정당한 의견이나 불만을 반영하고 그
              피해를 보상처리하기 위하여 피해보상처리기구를 설치․운영합니다.
              <br />
              [2] “몰”은 이용자로부터 제출되는 불만사항 및 의견은 우선적으로 그
              사항을 처리합니다. 다만, 신속한 처리가 곤란한 경우에는 이용자에게
              그 사유와 처리일정을 즉시 통보해 드립니다.
              <br />
              [3] “몰”과 이용자 간에 발생한 전자상거래 분쟁과 관련하여 이용자의
              피해구제신청이 있는 경우에는 공정거래위원회 또는 시·도지사가
              의뢰하는 분쟁조정기관의 조정에 따를 수 있습니다.
              <br />
              제24조(재판권 및 준거법)
              <br />
              [1] “몰”과 이용자 간에 발생한 전자상거래 분쟁에 관한 소송은 제소
              당시의 이용자의 주소에 의하고, 주소가 없는 경우에는 거소를
              관할하는 지방법원의 전속관할로 합니다. 다만, 제소 당시 이용자의
              주소 또는 거소가 분명하지 않거나 외국 거주자의 경우에는
              민사소송법상의 관할법원에 제기합니다.
              <br />
              [2] “몰”과 이용자 간에 제기된 전자상거래 소송에는 한국법을
              적용합니다. &nbsp; &nbsp;2. 등록 내용에 허위, 기재누락, 오기가
              있는 경우
              <br />
              &nbsp; &nbsp; 3. 기타 회원으로 등록하는 것이 “몰”의 기술상 현저히
              지장이 있다고 판단되는 경우
              <br />
              &nbsp; [3] 회원가입계약의 성립 시기는 “몰”의 승낙이 회원에게
              도달한 시점으로 합니다.
              <br />
              &nbsp; [4] 회원은 회원가입 시 등록한 사항에 변경이 있는 경우,
              상당한 기간 이내에 “몰”에 대하여 회원정보 수정 등의 방법으로 그
              변경사항을 알려야 합니다.
              <br />
              제7조(회원 탈퇴 및 자격 상실 등)
              <br />
              &nbsp; [1] 회원은 “몰”에 언제든지 탈퇴를 요청할 수 있으며 “몰”은
              즉시 회원탈퇴를 처리합니다.
              <br />
              &nbsp; [2] 회원이 다음 각 호의 사유에 해당하는 경우, “몰”은
              회원자격을 제한 및 정지시킬 수 있습니다.
              <br />
              &nbsp; &nbsp; 1. 가입 신청 시에 허위 내용을 등록한 경우
              <br />
              &nbsp; &nbsp; 2. “몰”을 이용하여 구입한 재화 등의 대금, 기타
              “몰”이용에 관련하여 회원이 부담하는 채무를 기일에 지급하지 않는
              경우
              <br />
              ...
              공서양속에 반하는 행위를 하는 경우
              <br />
              &nbsp; [3] “몰”이 회원 자격을 제한․정지 시킨 후, 동일한 행위가 2회
              이상 반복되거나 30일 이내에 그 사유가 시정되지 아니하는 경우
              “몰”은 회원자격을 상실시킬 수 있습니다.
              <br />
              &nbsp; [4] “몰”이 회원자격을 상실시키는 경우에는 회원등록을
              ...
              약정하여 지정한 전자우편 주소로 할 수 있습니다.
              <br />
              &nbsp; [2] “몰”은 불특정다수 회원에 대한 통지의 경우 1주일이상
              “몰” 게시판에 게시함으로서 개별 통지에 갈음할 수 있습니다. 다만,
              회원 본인의 거래와 관련하여 중대한 영향을 미치는 사항에 대하여는
              개별통지를 합니다.
              <br />
              제9조(구매신청 및 개인정보 제공 동의 등)
              <br />
              &nbsp; [1] “몰”이용자는 “몰”상에서 다음 또는 이와 유사한 방법에
              ...
              <br />
              &nbsp; &nbsp; &nbsp; &nbsp;3. 약관내용, 청약철회권이 제한되는
              서비스, 배송료․설치비 등의 비용부담과 관련한 내용에 대한 확인
              <br />
              ...
              제10조 (계약의 성립)
              <br />
              &nbsp; &nbsp;[1] &nbsp;“몰”은 제9조와 같은 구매신청에 대하여 다음
              각 호에 해당하면 승낙하지 않을 수 있습니다. 다만, 미성년자와
              계약을 체결하는 경우에는 법정대리인의 동의를 얻지 못하면 미성년자
              본인 또는 법정대리인이 계약을 취소할 수 있다는 내용을 고지하여야
              합니다.
              <br />
              &nbsp; &nbsp; 1. 신청 내용에 허위, 기재누락, 오기가 있는 경우
              <br />
              ...
              지장이 있다고 판단하는 경우
              <br />
              &nbsp; [2] “몰”의 승낙이 제12조제1항의 수신확인통지형태로
              이용자에게 도달한 시점에 계약이 성립한 것으로 봅니다.
              <br />
              &nbsp; [3] “몰”의 승낙의 의사표시에는 이용자의 구매 신청에 대한
              확인 및 판매가능 여부, 구매신청의 정정 취소 등에 관한 정보 등을
              포함하여야 합니다.
              <br />
              제11조(지급방법) “몰”에서 구매한 재화 또는 용역에 대한
              대금지급방법은 다음 각 호의 방법중 가용한 방법으로 할 수 있습니다.
              ...
              제12조(수신확인통지․구매신청 변경 및 취소)
              <br />
              &nbsp; [1] “몰”은 이용자의 구매신청이 있는 경우 이용자에게
              수신확인통지를 합니다.
              <br />
              &nbsp; [2] 수신확인통지를 받은 이용자는 의사표시의 불일치 등이
              있는 경우에는 수신확인통지를 받은 후 즉시 구매신청 변경 및 취소를
              요청할 수 있고 “몰”은 배송 전에 이용자의 요청이 있는 경우에는 지체
              없이 그 요청에 따라 처리하여야 합니다. 다만 이미 대금을 지불한
              경우에는 제15조의 청약철회 등에 관한 규정에 따릅니다.
              <br />
              ...
              따릅니다.
              <br />
              &nbsp; [2] 이용자는 재화 등을 배송 받은 경우 다음 각 호의 1에
              해당하는 경우에는 반품 및 교환을 할 수 없습니다.
              <br />
              &nbsp; &nbsp; 1. 이용자에게 책임 있는 사유로 재화 등이 멸실 또는
              훼손된 경우(다만, 재화 등의 내용을 확인하기 위하여 포장 등을
              ...
              <br />
              &nbsp; [3] 제2항제2호 내지 제4호의 경우에 “몰”이 사전에 청약철회
              등이 제한되는 사실을 소비자가 쉽게 알 수 있는 곳에 명기하거나
              시용상품을 제공하는 등의 조치를 하지 않았다면 이용자의 청약철회
              등이 제한되지 않습니다.
              <br />
              &nbsp; [4] 이용자는 제1항 및 제2항의 규정에 불구하고 재화 등의
              ...
              제16조(청약철회 등의 효과)
              <br />
              &nbsp; [1] “몰”은 이용자로부터 재화 등을 반환받은 경우 3영업일
              이내에 이미 지급받은 재화 등의 대금을 환급합니다. 이 경우 “몰”이
              이용자에게 재화등의 환급을 지연한때에는 그 지연기간에 대하여
              「전자상거래 등에서의 소비자보호에 관한 법률 시행령」제21조의2에서
              정하는 지연이자율을 곱하여 산정한 지연이자를 지급합니다.
              <br />
              ...
              제17조(개인정보보호)
              <br />
              &nbsp; [1] “몰”은 이용자의 개인정보 수집시 서비스제공을 위하여
              필요한 범위에서 최소한의 개인정보를 수집합니다.
              <br />
              &nbsp; [2] “몰”은 회원가입시 구매계약이행에 필요한 정보를 미리
              ...
              이용자에게 그 목적을 고지하고 동의를 받습니다.
              <br />
              &nbsp; [4] “몰”은 수집된 개인정보를 목적외의 용도로 이용할 수
              ...
              제18조(“몰“의 의무)
              <br />
              &nbsp; [1] “몰”은 법령과 이 약관이 금지하거나 공서양속에 반하는
              행위를 하지 않으며 이 약관이 정하는 바에 따라 지속적이고,
              안정적으로 재화․용역을 제공하는데 최선을 다하여야 합니다.
              <br />
              &nbsp; [2] “몰”은 이용자가 안전하게 인터넷 서비스를 이용할 수
              있도록 이용자의 개인정보(신용정보 포함)보호를 위한 보안 시스템을
              갖추어야 합니다.
              <br />
              &nbsp; [3] “몰”이 상품이나 용역에 대하여 「표시․광고의 공정화에
              관한 법률」 제3조 소정의 부당한 표시․광고행위를 함으로써 이용자가
              손해를 입은 때에는 이를 배상할 책임을 집니다.
              <br />
              &nbsp; [4] “몰”은 이용자가 원하지 않는 영리목적의 광고성
              전자우편을 발송하지 않습니다.
              <br />
              제19조(회원의 ID 및 비밀번호에 대한 의무)
              <br />
              ...
              회원에게 있습니다.
              <br />
              &nbsp; [2] 회원은 자신의 ID 및 비밀번호를 제3자에게 이용하게
              해서는 안됩니다.
              <br />
              &nbsp; [3] 회원이 자신의 ID 및 비밀번호를 도난당하거나 제3자가
          ...
          <div className="join-agree-box">
            <input
              type="checkbox"
              id="join-clause2"
              checked={agreeClause2}
              onChange={() => {
                setAgreeClause2(!agreeClause2);
              }}
            />
            <label for="join-clause2">[필수] 개인정보 수집 및 이용 동의</label>
            <p
              className="join-see-clause"
              onClick={() => {
                setIsClause2Show(!isClause2Show);
              }}
            >
              약관보기
            </p>
          ...
          <div
            className={
              isClause2Show ? "join-clause" : "join-clause join-clause-hide"
            }
          >
            <p>
              ** 본 양식은 쇼핑몰 운영에 도움을 드리고자 샘플로 제공되는
              ...
              <br />o 부정거래 방지 및 쇼핑몰 운영방침에 따른 보관 : OO년
              <br />
              나. 관련 법령에 의한 정보보유 사유
          ...
          <div className="join-agree-box">
            ...
            />
            <label for="join-clause3">[선택] SMS 수신 동의</label>
            ...
            />
            <label for="join-clause4">[선택] 이메일 수신 동의</label>
          </div>
        </div>
