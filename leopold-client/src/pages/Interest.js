...
export default function Interest() {
    ...
    const printInterestList = interestList?.map((interest, index) => (
        <InterestTable interest={interest} key={index}
            selectedUidList={selectedUidList} setSelectedUidList={setSelectedUidList} />
    ));
                ...
                <div className="interest">
                    ...
                    <div className="interest-main">
                        ...
                        <div className="interest-function-container">
                            <button onClick={handleClickDeleteSelected}>선택상품을 삭제</button>
                            <button onClick={handleClickDeleteAll} style={{ marginLeft: 10 }}>관심상품 목록 비우기</button>
                        </div>
