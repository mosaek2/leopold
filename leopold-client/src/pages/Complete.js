  ...
  return (
    <div className="complete">
      ...
      <div className="background">
        ...
        <div>
          <div className="complete-title-box">결제수단</div>

          <div
            className="complete-content-box"
          ...
          >
            ...
            <div style={{ height: 60 }}>
              ...
              <br />
              <br />
              입금자: {order?.holder}, 계좌번호: {order?.account} (레오폴드(주))
            </div>
          </div>
        </div>

        <div>
          <div className="complete-title-box">배송지</div>

          <div
            className="complete-content-box"
            style={{ display: "flex", fontSize: 15 }}
          >
            <div style={{ width: 96, color: "#636363" }}>받는 사람</div>
          ...
          <div
            ...
            style={{ display: "flex", fontSize: 15 }}
          >
            <div style={{ width: 96, color: "#636363" }}>주소</div>
            <div>
          ...
          <div
            ...
            style={{ display: "flex", fontSize: 15 }}
          >
            <div style={{ width: 96, color: "#636363" }}>연락처</div>
            <div>{order?.phone}</div>
          </div>
          ...
          >
            ...
            <div style={{ height: 60 }}>
              ...
              <br />
              <br />
              {order?.message === "default" ? undefined : order?.message}
            </div>
          </div>
        </div>

        <div>
          <div className="complete-title-box">주문 상품</div>

          <div className="complete-content-box">{printWishList}</div>
        </div>
      </div>
      ...
      >
        <button
          className="complete-btn-1"
          onClick={() => {
            navigate(`/order/detail?orderUid=${order?.uid}`);
          }}
        >
          주문확인하기
        </button>
        <button
          className="complete-btn-2"
          onClick={() => {
            navigate(`/shopping`);
          }}
        >
