...
export default function Shopping() {
    ...
    const categoryList1 =
        ["FC900RBT MX2A", "FC900RBT", "NP900RBT", "FC750RBT MX2A", "FC750RBT", "NP750RBT", "FC730RBT MX2A", "FC630MBT MX2A", "FC660MBT", "FC980MBT", "FC650MDSBT"];
    const categoryList2 = ["FC900R MX2A", "FC900R", "FC750R", "FC980M", "FC660M", "FC650MDS", "FC210TP"];
    const categoryList3 = ["FC980C"];

    const printCategoryList1 = categoryList1?.map((ct, index) => {
        return (
            <div className={category === index + 7
    ...
    const printCategoryList2 = categoryList2?.map((ct, index) => (
        <div className={category === index + 18
            ? "shopping-category2-box-select" : "shopping-category2-box-not-select"} key={index}
    ...
    const printCategoryList3 = categoryList3?.map((ct, index) => (
        <div className={category === index + 25
            ? "shopping-category2-box-select" : "shopping-category2-box-not-select"} key={index}
        ...
        <div className="Shopping">
            ...
            <Main>
                ...
                <div className="shopping-category1-container">
                    <div className={(category >= 7 && category <= 17) || (category === 4)
                        ? "shopping-category1-select" : "shopping-category1-not-select"}
                        onClick={() => handleClickCategory(4)}>
                        기계식 유·무선 키보드
                    </div>
                    <div className={(category >= 18 && category <= 24) || (category === 5)
                        ? "shopping-category1-select" : "shopping-category1-not-select"}
                        onClick={() => handleClickCategory(5)}>
                        기계식 유선 키보드
                    </div>
                    <div className={(category >= 25) || (category === 6)
                        ? "shopping-category1-select" : "shopping-category1-not-select"}
                ...
                <div className="shopping-sort-container">
                    <p style={{ fontSize: 12, color: "#6a6a6a" }}>
                        총 <span style={{ color: "black", fontWeight: "bold" }}>
                            {productList?.length}
                        </span> 개의 제품이 있습니다.
                    </p>

                    <select className="shopping-sort-select" onChange={handleChangeSort} defaultValue={sort}>
